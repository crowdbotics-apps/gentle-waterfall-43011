  ...
  return <SafeAreaView style={_styles.iJgxMQne}>
      ...
      <View style={_styles.HrmPYOcl}>
        ...
        item
              ...
              <Button title="View Details" onPress={() => setSelectedSession(item)} />
            </View>} />
      </View>
      {selectedSession && <ScrollView style={_styles.GrNYOOHT}>
        ...
        uri: 'https://tinyurl.com/42evm3m3'
          ...
          <Text style={_styles.uuuwTLpl}>Pain Level: {selectedSession.painLevel}</Text>
          <Text style={_styles.NdOUqjxt}>Step Level: {selectedSession.stepLevel}</Text>
        </ScrollView>}
    </SafeAreaView>;
};
